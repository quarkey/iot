...
func (s *Server) InsertTestdata() error {
	...
	testdata := []query{
		...
		values(1,'temp&hydro','Temperatur/hydro measurement, growhouse 1','8a1bbddba98a8d8512787d311352d951',2,'["temp", "hydro"]' ,'["float", "float"]', '[true,true]');`},
		...
		values(2,'Bicycle to work','Battery-driven lat/long tracker','4987fb174ae91dc702394024378fc1cd',1,'["lat (n)", "long (e)", "direction"]', '["float", "float", "string"]', '[true,true,false]');`},
